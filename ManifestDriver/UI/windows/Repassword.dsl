...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="Repassword" controller="RepasswordController" namespace="com.lionbridge.driver">
    <import ref="Repassword.css" type="css"/>
    <link type="text/css" href="sys/theme.css"/>
    <div id="viewPage0">
        <navigatorbar id="navigatorbar0" title="修改密码">
            <input id="button0" class="ngbbuttonclass" onclick="this.closeRepassword()" type="button"/>
            <label id="label1"/>
